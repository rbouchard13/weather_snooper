...
function addWeather(current) {
	document.getElementById("station").innerHTML = obsStations[0].name + "<br><span style='padding:10px'>" +obsStations[0].airport + "</span>&nbsp<img src='images/radar.png' width='20px' style='margin:5px'/>";
