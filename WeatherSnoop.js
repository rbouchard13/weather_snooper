...
function addWeather(current) {
	document.getElementById("station").innerHTML = obsStations[0].name + "<br><span style='margin:5px'>" +obsStations[0].airport + "</span>&nbsp<img src='images/radar.png' width='20px'/>";
