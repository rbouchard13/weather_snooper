...
function addWeather(current) {
	document.getElementById("station").innerHTML = obsStations[0].name + "<br><span style='margin-top:10px;margin-bottom:10px;margin-left:5px'>" +obsStations[0].airport + "</span><img src='images/radar.png' width='20px'/>";
